            ...
            <>
                ...
                <PageLayout isContainer={true} className={"mt-[50px] mb-[50px]"}>
                    <div className="col">
                        ...
                        <div>
                            It seems that the article you&#39;re trying to access is either unavailable or doesn&#39;t
                            exist. Please check the URL or go back to the homepage to explore other content.
                        </div>
                    </div>
                </PageLayout>
            </>
        ...
        return (
            <>
                <Head>
                    ...
                    <meta property="og:description" content={article?.ogDescription || article?.description}/>
                    {article?.ogImage && <meta property="og:image" content={article?.ogImage}/>}
                    <meta property="og:url" content={`https://www.kerry.college/articles/${article?.alias}`}/>
